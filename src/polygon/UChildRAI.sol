...
contract UChildRAI is UChildERC20 {
    ...
    function permit(
        ...
        require(holder == ecrecover(digest, v, r, s), "UChildRAI: INVALID-PERMIT");
        require(expiry == 0 || now <= expiry, "UChildRAI: PERMIT-EXPIRED");
        require(nonce == nonces[holder]++, "UChildRAI: INVALID-NONCE");
